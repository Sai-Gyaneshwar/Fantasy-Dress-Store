...
const Pagination = ({pages, setCurrentPage, currentProducts, sortedProducts}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentProducts.length}</b> out of <b>{sortedProducts.length}</b> entries</div>
